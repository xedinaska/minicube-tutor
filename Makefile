...
pre_build:
	docker run --rm -i -v $(CURDIR):/gopath/src/github.com/xedinaska/minicube-tutor -e "GOPATH=/gopath" -w /app golang:latest sh -c 'cd /gopath/src/github.com/xedinaska/minicube-tutor && go build -o ./bin/app_linux ./cmd/main.go'
